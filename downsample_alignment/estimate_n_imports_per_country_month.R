...
countries_to_plot <- c("Italy", "Germany", "France", "United Kingdom", 
                       "United States", "Belgium", "Austria", "Netherlands")
color_scale <- c(
  RColorBrewer::brewer.pal(n = length(countries_to_plot), name = "Paired"), 
  "brown")
